...
#Oleh karena itu, 10*10 adalah petak yang terlalu besar saat n=342. Tapi kami akan membahasnya di sini untuk tujuan ilustrasi.
...
Data_penguin_som<- som(Data_penguin.sc, grid=Data_penguin.grid, rlen=700, alpha=c(0.05,0.01), keep.data = TRUE)
```
```{r}
summary(Data_penguin.som)
```
