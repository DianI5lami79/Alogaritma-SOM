...
library(readxl)
data_kemiskinan_Dian_islamiati_Dahlan_A1202101709_ <- read_excel("~/Semester 3/Metode Regresi/data_kemiskinan_Dian_islamiati_Dahlan_(A1202101709).xlsx")
View(data_kemiskinan_Dian_islamiati_Dahlan_A1202101709_)
```
#### Palet
...
```{r}
#well, first of all:
summary(data_kemiskinan_Dian_islamiati_Dahlan_A1202101709_)
```
